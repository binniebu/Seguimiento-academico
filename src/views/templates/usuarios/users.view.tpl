...
$resultado = \Dao\UsuarioDao::getUsers($buscar, $estado, "id_usuario", false, $pagina, $itemsPorPagina);

$usuarios = $resultado["usuarios"] ?? array();
$total = intval($resultado["total"] ?? count($usuarios));
$itemsPorPagina = intval($resultado["itemsPerPage"] ?? 10);
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="badge <?php echo ($usuario["estado"] ?? "") === "activo" ? "bg-success" : "bg-secondary"; ?>">
                                        <?php echo htmlspecialchars(ucfirst($usuario["estado"] ?? "inactivo")); ?>
                                    </span>
                                </td>
